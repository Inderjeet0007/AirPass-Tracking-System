            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu3">
                        ...
                        <li>
                            <a href="register.html">Register New Admin</a>
                        </li>
                    </ul>
                </li>
                <li>
        ...
        <div id="content">
            ...
            <div class="padding-md">
                    <div style="margin-bottom: 1em;" class="pull-right text-right">
                        ...
                        <a href="add_reader.php" class="btn btn-success">Add New Reader</a>
            ...
            $sql="select reader_id,r_name,mac_add from reader ";
            $res= mysqli_query($link,$sql);
               ...
               echo "<td><button class='button3'><a onclick= 'return confirm(\"$emessage\")' href='records_r.php?id=" . $id . "'>Edit</a></button>
            	<button class='button2'><a onclick= 'return confirm(\"$dmessage\")' href='delete_r.php?id=" . $id . "'>Delete</a></button></td>";
