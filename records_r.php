...
$id = intval($_GET['id']);
if($id > 0) {
  $res = mysqli_query($db, "SELECT * FROM reader WHERE reader_id = $id");
...
if(isset($_POST['update']))
{
    ...
    if(empty($b_name) || empty($mac_add)) {
        if(empty($b_name)) {
            echo "<font color='red'>Reader Name field is empty.</font><br/>";
        }
        ...
        //updating the table
        $sql= "UPDATE reader "."SET r_name= '$b_name', mac_add= '$mac_add' ". "WHERE reader_id=$id";
      ...
      <div class="col-md-12">
          <div class="panel panel-default">
            ...
            <form  method="post" action="<?php $_PHP_SELF ?>">
              <?php echo "<br>READER ID: ".$id."<br><br>"; ?>
